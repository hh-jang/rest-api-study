...
`POST` 요청을 사용해서 새 Pojo를 만들 수 있다.

operation::create-pojo[snippets='request-fields,curl-request,http-request,request-headers,http-response,response-headers,response-fields,response-fields-pojo']
